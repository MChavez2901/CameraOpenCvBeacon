...
public class FileHelper {
    ...
    private static String createFilename(String img, String tag) {
        ...
        String FileN = IMG + img + TAG + tag + EXT;
        return FileN;
    }
     ...
     */
    private static String createFilename(String tag) {
        ...
        return createFilename(DATE_FORMAT.format(new Date()),tag);    }
    ...
    private static File createFile(File directory, String filename, String newTag) {
        ...
        if(filename == null)
            newFilename = createFilename( newTag);
